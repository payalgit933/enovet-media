        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <Link href="/" className="inline-block">
              <h2 className="text-2xl font-bold bg-gradient-to-r from-white via-secondary to-white bg-clip-text text-transparent">
                Enovet Media
              </h2>
            </Link>
            <p className="text-gray-400 text-sm leading-relaxed">
              Empowering businesses with innovative digital solutions. We help brands grow through strategic marketing and creative excellence.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link href="/services/web-development" className="text-gray-400 hover:text-secondary transition-colors">
                  Web Development
                </Link>
              </li>
              <li>
                <Link href="/services/ppc-advertising" className="text-gray-400 hover:text-secondary transition-colors">
                  PPC Advertising
                </Link>
              </li>
              <li>
                <Link href="/services/branding" className="text-gray-400 hover:text-secondary transition-colors">
                  Branding
                </Link>
              </li>
              <li>
                <Link href="/services/seo" className="text-gray-400 hover:text-secondary transition-colors">
                  SEO Optimization
                </Link>
              </li>
              <li>
                <Link href="/services/social-media" className="text-gray-400 hover:text-secondary transition-colors">
                  Social Media
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Enovet Media. All rights reserved.
            </p>
